...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2019 a las 21:53:11
...
CREATE TABLE `peliculas` (
  ...
  `EstrellaPrincipal` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `peliculas` (`id`, `Nombre`, `Tipo`, `FechaDeEstreno`, `CantidadDePublico`, `Foto`, `EstrellaPrincipal`) VALUES
